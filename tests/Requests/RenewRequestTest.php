...
/**
 * @covers \Xolphin\Requests\RenewRequest
 */
...
-----END CERTIFICATE REQUEST-----';
        ...
        return [
            'Includes all filled fields' => [
                ...
                (new RenewRequest(1, 1, $csr, DCVTypes::DNS_VALIDATION))
                    ->addDcv(
                        new DCVDomain(
                            'xolphin.nl',
                            DCVTypes::DNS_VALIDATION,
     ...
     */
    public function testGetApiRequestBody(array $expectedResults, RenewRequest $RenewRequest): void
    {
        $actualResults = $RenewRequest->getApiRequestBody();
