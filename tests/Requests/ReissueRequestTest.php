...
/**
 * @covers \Xolphin\Requests\ReissueRequest
 */
class ReissueRequestTest extends TestCase
{
...
-----END CERTIFICATE REQUEST-----';
        ...
        return [
            'Includes all filled fields' => [
                ...
                (new ReissueRequest( $csr, DCVTypes::DNS_VALIDATION))
                    ->addDcv(
                        new DCVDomain(
                            'xolphin.nl',
                            DCVTypes::DNS_VALIDATION,
     ...
     */
    public function testGetApiRequestBody(array $expectedResults, ReissueRequest $reissueRequest): void
    {
        $actualResults = $reissueRequest->getApiRequestBody();
